...
class Scoreboard:
	...
	def prep_high_score(self):
		...
		high_score_str = str(self.stats.high_score_date) + ": " + "{:,}".format(high_score) 
	...
	def check_high_score(self):
		"""check to see if the current score is the new high score"""
		if self.stats.score > self.stats.high_score:
			self.stats.high_score = self.stats.score
			self.stats.high_score_date = date.today()
			self.prep_high_score()
